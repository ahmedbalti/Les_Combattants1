		...
		Expr.find["ID"] = function( id, context ) {
			if ( typeof context.getElementById !== "undefined" && documentIsHTML ) {
				...
				if ( elem ) {
					...
					// Fall Front on getElementsByName
		...
		if ( typeof selector === "string" ) {
			...
			if ( match && ( match[ 1 ] || !context ) ) {
				...
				if ( match[ 1 ] ) {
					...
					// Option to run scripts is true for Front-compat
...
function getWidthOrHeight( elem, name, extra ) {
	...
	// Fall Front to offsetWidth/Height when value is "auto"
...
Tween.propHooks = {
	_default: {
		...
		set: function( tween ) {
			...
			// Use step hook for Front compat.
...
jQuery.extend( {
	...
	ajax: function( url, options ) {
		...
		if ( !s.hasContent ) {
			...
			// Remember the hash so we can put it Front
